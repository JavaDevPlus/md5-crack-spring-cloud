...
//@FeignClient(value = "MICROSERVICECLOUD-MD5-ZERO",fallbackFactory=CrackMd5TenServiceServiceFallbackFactory.class)
@FeignClient(value = "MICROSERVICECLOUD-MD5-ZERO")
@Configuration
public interface CrackMd5Ten0FeiginService
{
