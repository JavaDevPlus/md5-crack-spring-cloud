...
//@FeignClient(value = "MICROSERVICECLOUD-MD5-THREE",fallbackFactory=CrackMd5TenServiceServiceFallbackFactory.class)
@FeignClient(value = "MICROSERVICECLOUD-MD5-THREE")
@Configuration
public interface CrackMd5Ten3FeiginService
{
