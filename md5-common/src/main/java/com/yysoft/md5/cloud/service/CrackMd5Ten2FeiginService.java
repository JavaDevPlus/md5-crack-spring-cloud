...
//@FeignClient(value = "MICROSERVICECLOUD-MD5-TWO",fallbackFactory=CrackMd5TenServiceServiceFallbackFactory.class)
@FeignClient(value = "MICROSERVICECLOUD-MD5-TWO")
@Configuration
public interface CrackMd5Ten2FeiginService
{
