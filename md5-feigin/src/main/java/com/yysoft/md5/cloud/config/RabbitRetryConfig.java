package com.yysoft.md5.cloud.config;
...
public class RabbitRetryConfig {
    ...
    public ExponentialBackOffPolicy backOffPolicyByProperties() {
        ...
        long maxInterval = properties.getListener().getSimple().getRetry().getMaxInterval();
        long initialInterval = properties.getListener().getSimple().getRetry().getInitialInterval();
